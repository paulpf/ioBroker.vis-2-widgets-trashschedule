...
describe('ioBroker.vis-2-widgets-trashschedule', () => {
    before(async function () {
        ...
        // open widgets
        await helper.palette.openWidgetSet(null, 'ioBroker.vis-2-widgets-trashschedule');
        await helper.screenshot(null, '02_widgets_opened');
    });

    it('Check trash schedule widget', async function () {
        this.timeout(60000);
        const widgets = await helper.palette.getListOfWidgets(null, 'ioBroker.vis-2-widgets-trashschedule');
